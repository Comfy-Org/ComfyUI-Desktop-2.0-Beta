...
The Desktop app's terms are in the **EULA** above. The broader **comfy.org Terms of Service** (covering the website, accounts, and Comfy Cloud) lives at [comfy.org/terms](https://comfy.org/terms) — when you sign in to Comfy Cloud from Desktop, you're agreeing to those terms separately.
...
| Doc | Current Effective Date | How it's accepted |
|-----|------------------------|-------------------|
| EULA | See `EULA.md` | First-launch consent screen (in-product) |
| Privacy Policy | 2026-05-05 | First-launch consent screen + linked from settings |
| Third-Party Notices | See file | Linked from About panel (in-product) |
...
*Last updated: 2026-05-08 · AI-drafted starting point pending counsel review*
