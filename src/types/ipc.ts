...
export interface DetailField {
  ...
  browseOnly?: boolean
  /** Auto-fire this action after the field value changes (e.g.
   *  switching update channel triggers `check-update` so the preview
   *  metadata refreshes without an extra click). */
